...
let gitInitDefinition = "git init intializes a local repository in your projet.";
...
let gitCloneDefinition = "git clone is used to take an existing repo and make a clone or copy of that repo at another location.";
...
let gitStatusDefinition = "git status displays the directroy and lets you see the changes that have happened, which changes haven't happened, and which files aren't being tracked by git.";
