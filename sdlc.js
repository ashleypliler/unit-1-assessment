...
const analysisOfRequirements = "The analysis includes gathering all the specific details required for a new system as well as determining the first ideas for prototypes.";
...
const implementation = "Different designs will be integrated into the primary code usually through, user training, installation of hardware, installation of software, and integration of the system into the daily processes.";
